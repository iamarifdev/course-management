...
namespace CourseManagement.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250323164356_FixStudentCourseClassForeignKeyRelation")]
    partial class FixStudentCourseClassForeignKeyRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CourseManagement.Domain.StudentCourseClasses.StudentCourseClass", b =>
                {
                    ...
                    b.HasIndex("CourseId")
                        .HasDatabaseName("ix_student_course_classes_course_id");
                    ...
                    b.HasIndex("StudentId", "ClassId")
                        .IsUnique()
                        .HasDatabaseName("ix_student_course_classes_student_id_class_id")
                        .HasFilter("\"is_deleted\" = false");
            ...
            modelBuilder.Entity("CourseManagement.Domain.StudentCourseClasses.StudentCourseClass", b =>
                {
                    ...
                    b.HasOne("CourseManagement.Domain.Courses.Course", "Course")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_student_course_classes_courses_course_id");
